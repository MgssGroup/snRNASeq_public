...
setwd(mainDir)
outDir <-
  "/lustre07/scratch/senthil/Corina_snRNAseq_in_MDD_R006421/Analysis_report/Figures_and_Tables_all/Female_dataset/01_pseudobulk/01_cell_Broad"
...
#loop_parameters$ClusterID <- c("cell_type")
#cell_ID <- c("ExN10_L46")
cell_ID <- c("Mic")
#FEMALE##
