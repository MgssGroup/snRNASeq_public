...
setwd(mainDir)
outDir <-
  "/lustre07/scratch/senthil/Corina_snRNAseq_in_MDD_R006421/Analysis_report/Figures_and_Tables_all/Male_dataset/01_pseudobulk/02_cell_subtype"
...
for (i in 8:10)  {
 # for (i in 8:nrow(loop_parameters))  {
run_name_dir <-
  paste(
